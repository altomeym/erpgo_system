...
Route::group(
    ...
    Route::get('settings', 'SystemController@companyIndex')->name('settings');
...
Route::get('/vendor/bill/{id}/', 'BillController@invoiceLink')->name('bill.link.copy')->middleware(
    [
        'auth',
        'XSS',
    ]
...
//    Route::get('/bill/{id}/', 'PurchaseController@purchaseLink')->name('purchase.link.copy');
    ...
    Route::post('purchase/{id}/payment/{pid}/destroy', 'PurcaseController@paymentDestroy')->name('purchase.payment.destroy');
...
//pos barcode
Route::get('barcode/pos', 'PosController@barcode')->name('pos.barcode')->middleware(['auth', 'XSS']);
Route::get('setting/pos', 'PosController@setting')->name('pos.setting')->middleware(['auth', 'XSS']);
Route::post('barcode/settings', 'PosController@BarcodesettingStore')->name('barcode.setting');
Route::get('print/pos', 'PosController@printBarcode')->name('pos.print')->middleware(['auth', 'XSS']);
Route::post('pos/getproduct', 'PosController@getproduct')->name('pos.getproduct')->middleware(['auth', 'XSS']);
Route::any('pos-receipt', 'PosController@receipt')->name('pos.receipt')->middleware(['auth', 'XSS']);

Route::post('/cartdiscount','PosController@cartdiscount')->name('cartdiscount')->middleware(['auth','XSS']);
