            ...
            <?php if(\Auth::user()->type != 'client'): ?>
                ...
                <!--------------------- End Products System ----------------------------------->
                        ...
                        <?php if( Gate::check('manage warehouse') ||  Gate::check('manage purchase')  || Gate::check('manage pos') || Gate::check('manage print settings')): ?>
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' )?' active dash-trigger':''); ?>">
                                ...
                                <ul class="dash-submenu <?php echo e((Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase')?'show':''); ?>">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage pos')): ?>
                                        ...
                                        <li class="dash-item <?php echo e((Request::route()->getName() == 'pos.report' ) ? ' active' : ''); ?>">
...
<?php /**PATH D:\wamp64\www\codecanyon-xth7yGc2-erpgo-all-in-one-business-erp-with-project-account-hrm-crm-pos\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>