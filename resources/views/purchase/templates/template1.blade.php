                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title ">{{__('Purchase')}}</div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{Utility::purchaseNumberFormat($settings,$purchase->purchase_id)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Purchase Date')}}:</td>
                                                <td>{{Utility::dateFormat($settings,$purchase->purchase_date)}}</td>
                                            </tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{$purchase->totalQuantity}}</pre>
                                                </div>
                                                <div class="d-table-td w-4">
                                                    <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$purchase->totalRate)}}</pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$purchase->totalTaxPrice) }}</pre>
                                                </div>

                                                    <div class="d-table-td w-4">
                                                        <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$purchase->totalDiscount)}}</pre>
                                                    </div>


                                                <div class="d-table-td w-4 ">
                                                    <span>{{Utility::priceFormat($settings,$purchase->getSubTotal())}}
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$purchase->getSubTotal())}}</div>
                                                    </div>
                                                    @if($purchase->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$purchase->getTotalDiscount())}}</div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$purchase->getSubTotal()-$purchase->getTotalDiscount()+$purchase->getTotalTax())}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Paid')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,($purchase->getTotal()-$purchase->getDue()))}}</div>
                                                    </div>

                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$purchase->getDue())}}</div>
                                                    </div>
                                                </div>
                                            </div>
