...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="ti ti-inbox"></i> <span class="messenger-headTitle">{{__('MESSAGES')}}</span> </a>
                {{-- header buttons --}}
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span>{{__('Recent')}}</a>
                <a href="#" @if($route == 'group') class="active-tab" @endif data-view="groups">
                    <span class="ti ti-users"></span>{{__('Members')}}</a>
            </div>
        </div>
        {{-- tabs and lists --}}
        <div class="m-body">
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ asset('/storage/'.Auth::user()->avatar) }}');"></div>
                    @else
        ...
        <div class="internet-connection">
            ...
            <span class="ic-noInternet"><span class="ic-noInternet">{{__('No internet access')}}</span>
        </span>
        </div>
        {{-- Messaging area --}}
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>{{__('Please select a chat to start messaging')}}</span></p>
            </div>
            {{-- Typing indicator --}}
